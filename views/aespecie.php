...
<p class="lead" align="center"  style="margin-top: 0px; background-color:#ccc; " >APOYOS EN ESPECIE</p> <hr class="my-1" >
...
<!-- Modal -->
            ...
            $table = new tablacuerpo();
             $table->teconomico("SELECT * FROM solicitante where idapoyo=1  order by Nombre",1);
             ?>
